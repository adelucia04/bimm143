...
- [Background and Preparing the
  Data](#background-and-preparing-the-data)
- [Create diagnosis vector for
  later](#create-diagnosis-vector-for-later)
  - [Principal Component Analysis
    (PCA)](#principal-component-analysis-pca)
  - [Interpreting PCA results](#interpreting-pca-results)
- [4. Hierarchical Clustering](#4-hierarchical-clustering)
  - [Selecting numbers of clusters](#selecting-numbers-of-clusters)
...
analysis of the dataset - we don’t want to pass this to PCA, etc. We
will save it as a separate vector that we can use later to compare ou
...
optional arugement `scale = TRUE` here as the data
...
0.4427 is the proportion of the original variance captured in the first
principal component.
...
This plot is very difficultt to understand because there is a lot going
on in such a little frame. Also the numbers and column names are
preactically impossible to read due to the immense overlap and being in
the same colors. It stands out to me that the numbers are very clustered
but with some outlying numbers.
...
Answer to Q8: I notice that the plot of PC1 vs PC3 is lower than in the
plot of PC1 vs PC2. I notice that there is a separation between the
blue, malignant patients and the red, benign patients.
...
I did not see any features with larger contributions than this one with
-0.26085376.
...
The idea here is that I can take my new variables (the scores on the PCs
`wisc.pr$x`) that are better descriptors of the dara-set than the
...
Our cluster “1” has 179 with “M” diagnosis or cluster “2” has 333 “B”
diagnosis
